...
export default {
    ...
    methods: {
        /*
            ...
            Crida a l’API per a la identificació d’un usuari amb la informació recollida del formulari i el token creat.
        ...
        */
        ...
        /*
            ...
            Creació d’un token amb caràcters alphanumerics aleatoris en una cookie
        ...
        */
        generateToken() {
            ...
            // això fa que s'esperi a continuar el codi haver rebut resposta de la API
            var xmlhttp = new XMLHttpRequest();
            xmlhttp.open("PUT", input, false);
            //Enviem el Token per Header
            xmlhttp.setRequestHeader("Content-type", "application/json");
            xmlhttp.send(JSON.stringify(apikey));
            output = JSON.parse(xmlhttp.responseText);
