<template>
    <svg class="hexagon" style="width:200px; height: 200px; filter: drop-shadow(5px 5px 7px black);">
        ...
        <text x="50%" y="50%" text-anchor="middle" alignment-baseline="middle" style="font-size: 16px; max-width: 50px;">
        <tspan x="50%" dy="-25px" style="font-size: 55px;">{{iconesEstat}}</tspan>
        <tspan x="50%" dy="55px" style="font-weight: bold; font-size: 18px;" lengthAdjust="spacingAndGlyphs" textLength="150">{{input_data}}</tspan>
        </text>
    </svg>
</template>
